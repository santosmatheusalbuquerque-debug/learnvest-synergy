  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-1/2 items-center justify-center bg-gradient-hero lg:flex">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_40%,hsl(12_80%_50%/0.15),transparent_60%)]" />
        <div className="relative z-10 max-w-md px-12 text-center">
          <div className="mx-auto mb-6 h-14 w-14 rounded-2xl bg-gradient-primary" />
          <h2 className="font-heading text-3xl font-bold text-foreground">
            Bem-vindo de volta à <span className="text-gradient">notice.me</span>
          </h2>
          <p className="mt-4 text-muted-foreground">
            Continue sua jornada de aprendizado e fique por dentro das últimas notícias.
          </p>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center px-4 lg:w-1/2">
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-muted-foreground">Entre com seu email e senha.</p>
          </div>
